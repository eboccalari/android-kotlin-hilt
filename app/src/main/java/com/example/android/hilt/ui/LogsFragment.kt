...
class LogsFragment : Fragment() {
    ...
    /**
     * If you want to change the database implementation you want to use, you just need to annotate
     * the injected fields with @DatabaseLogger instead of @InMemoryLogger.
     */
    @InMemoryLogger
    ...
    /**
     * Under the hood, Hilt will populate those fields in the onAttach() lifecycle method
     * with instances built in the dependencies container that Hilt automatically generated
     * for LogsFragment..
     */
